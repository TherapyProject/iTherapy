...
function Communication() {
    return (
        <div className="pb-14 pt-14 md:pl-10 lg:pl-20 pr-10" >
            ...
            <div className="flex justify-between md:flex-row flex-col">
                ...
                <Card link="/video" pic={videoCall} title="Video Call" description="For better experience therapists recommend video calls, but always remember that its a choice!" />
            </div>
