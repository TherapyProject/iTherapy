    ...
    <footer className="p-10 bg-yellow-200 flex justify-around gap-10 absolute left-0 bottom-0 right-0">
      <div>
        ...
        <div className="form-control w-80">
          <div className="relative pt-6">
            ...
            <button className="btn btn-primary absolute top--6 right-0 rounded-l-none" type="submit">Enter</button>
          </div>
        </div>
      </div>
      <div className="flex flex-col justify-around gap-5 items-center">
        <div className="mx-8 font-bold flex justify-end ">
          ...
          <a className="mx-8" href="/blogs">Blogs</a>
          <a className="mx-8" href="/about">About</a>
          <a className="mx-8" href="/contact">Contact</a>
        </div>
        <div className="flex flex-row gap-10">
          ...
          <a href="https://facebook.com">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" /></svg>
          </a>
        </div>
      </div>
    </footer>
