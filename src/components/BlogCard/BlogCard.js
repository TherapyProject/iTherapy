        ...
        <div className="flex justify-between py-2" >
          <div className="flex gap-1 lg:gap-2 items-center justify-center">
            ...
            <div className="flex flex-col justify-center items-start ">
              <div className="text-[0.70rem] lg:text-sm font-bold truncate hover:text-orange-500">{authName}</div>
              <div className="text-[0.60rem] lg:text-xs text-gray-500 truncate">Author</div>
            </div>
          </div>
          </div>
          </div>
