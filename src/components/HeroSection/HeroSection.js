    ...
    >
      <div className="flex flex-col items-center gap-14  ml-4">
        <div className="flex flex-col items-center justify-center gap-5 font-semibold">
          <p className=" text-4xl xl:text-5xl ">We Are Here To</p>
        ...
        <button
          type="button"
          className="hover:scale-105 transition text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-base md:text-lg lg:text-xl xl:text-2xl px-5 py-2.5 text-center  mb-2 "
        >
          BOOK AN APPOINTMENT
        </button>
      </div>
