...
function HeroSection() {
  ...
  return (
    <div className="font-['Poppins'] h-screen flex justify-center pt-12 items-center md:flex-row flex-col md:pl-10 md:gap-1 lg:gap-10 lg:pl-20 bg-cover bg-[url('components/HeroSection/HeroSection-images/linearbackground.png')]">
      <div className="flex flex-col items-center gap-8  ml-4">
        <div className="flex flex-col items-center justify-center gap-2 font-semibold">
          <p className="text-3xl xl:text-5xl ">We Are Here To</p>
          <span className="text-6xl  lg:text-7xl xl:text-8xl ">Help you</span>
          <button
            type="button"
