...
function Contact() {
  return (
    <div className="p-10">
      ...
      <div>
        <h2 className="card-title text-center md:card-title mt-5 mb-10">
          Type of contact
        </h2>
        <div className="text-justify md:flex justify-between">
          <div className="flex flex-col text-xl gap-8 ">
            <div className="flex items-center mr-4">
              ...
              <label
                ...
                className="ml-2  font-medium text-black-400 dark:text-gray-500"
              >
      ...
      <div className="flex">
        <div className="flex flex-col md:grid grid-cols-2 space-x-52 ">
          ...
          <div className="justify-self-start md: card w-72 bg-teal-50 text-primary-content mt-10 p-5 ">
