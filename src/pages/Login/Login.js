...
import Poster from '../../images/image 1.png';

function Login() {
  return (
    <section className="bg-stone-50 px-12 py-10  dark:bg-gray-900 grid md:grid-cols-2 items-center md:space-x-10">
        ...
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form className="space-y-4 md:space-y-6" action="#">
            <div>
              <label
                htmlFor="email"
                className="block mb-5 text-xl font-medium text-gray-900 dark:text-white"
              >
                Email
                <input
                  type="email"
            ...
            <div className="flex justify-center">
              <button type="submit" className="btn btn-info text-xl mr-10">
                Login
              </button>
              <a
                href="signup"
